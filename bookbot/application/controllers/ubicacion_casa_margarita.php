...
/*
|-----------------------------------------------------------------------
| Ubicacion_casa_margarita Controller
|-----------------------------------------------------------------------
|
| @author: 	Pablo Martínez
| @link:	 	http://www.greenlabs.com.mx
| @comments:	Ubicacion view controller
| @date:		Dec 2012
|
*/
class Ubicacion_casa_margarita extends CI_Controller{
	...
	private function loadPage(){
		...
		$this->load->view('site/ubicacion', $data);
	}

}//end of controller

// @eof Ubicacion_casa_margarita Controller ========================================================