...
/*
|-----------------------------------------------------------------------
| Servicios_casa_margarita Controller
|-----------------------------------------------------------------------
|
| @author: 	Pablo Martínez
| @link:	 	http://www.greenlabs.com.mx
| @comments:	Servicios view controller
| @date:		Dec 2012
|
*/
class Servicios_casa_margarita extends CI_Controller{
	...
	private function loadPage(){
		...
		$this->load->view('site/servicios', $data);
	}

}//end of controller

// @eof Servicios_casa_margarita Controller ========================================================